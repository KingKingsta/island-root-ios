...
import 'schema/active_orders_record.dart';
...
export 'schema/active_orders_record.dart';
...
/// Functions to query ActiveOrdersRecords (as a Stream and as a Future).
Future<int> queryActiveOrdersRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ActiveOrdersRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ActiveOrdersRecord>> queryActiveOrdersRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<List<ActiveOrdersRecord>> queryActiveOrdersRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<FFFirestorePage<ActiveOrdersRecord>> queryActiveOrdersRecordPage({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
