...
import 'profile_page_edit_copy_copy_model.dart';
export 'profile_page_edit_copy_copy_model.dart';

class ProfilePageEditCopyCopyWidget extends StatefulWidget {
  const ProfilePageEditCopyCopyWidget({Key? key}) : super(key: key);

  @override
  _ProfilePageEditCopyCopyWidgetState createState() =>
      _ProfilePageEditCopyCopyWidgetState();
}

class _ProfilePageEditCopyCopyWidgetState
    extends State<ProfilePageEditCopyCopyWidget> {
  late ProfilePageEditCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfilePageEditCopyCopyModel());
  }
